      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#skills" className="text-gray-700 hover:text-orange-500 transition-colors">
              Skills
            </Link>
            <Link href="#experience" className="text-gray-700 hover:text-orange-500 transition-colors">
              Experience
            </Link>
            <Link href="#education" className="text-gray-700 hover:text-orange-500 transition-colors">
              Education
            </Link>
